        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            ...
            override fun onSuccess(
                ...
                with(resultObject) {
                    ...
                    val publicRepos =
                        (if (this.getInt("public_repos") == 0) resources.getString(R.string.none) else this.getInt(
                            "public_repos"
                        ).toString()) + " ${context?.resources?.getString(
                            R.string.public_repos
                        )}"
                    val publicGists =
                        (if (this.getInt("public_gists") == 0) resources.getString(R.string.none) else this.getInt(
                            "public_gists"
                        ).toString()) + " ${context?.resources?.getString(
