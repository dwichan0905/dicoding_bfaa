...
import id.dwichan.preloaddata.services.DataManagerService
import id.dwichan.preloaddata.services.DataManagerService.Companion.CANCEL_MESSAGE
import id.dwichan.preloaddata.services.DataManagerService.Companion.FAILED_MESSAGE
import id.dwichan.preloaddata.services.DataManagerService.Companion.PREPARATION_MESSAGE
import id.dwichan.preloaddata.services.DataManagerService.Companion.SUCCESS_MESSAGE
import id.dwichan.preloaddata.services.DataManagerService.Companion.UPDATE_MESSAGE
...
class MainActivity : AppCompatActivity(), HandlerCallback {
    ...
    override fun loadSuccess() {
        Toast.makeText(this, "Berhasil meload data.", Toast.LENGTH_SHORT).show()
