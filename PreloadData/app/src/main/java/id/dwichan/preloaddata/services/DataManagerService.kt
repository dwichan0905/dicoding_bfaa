package id.dwichan.preloaddata.services

import android.app.Service
import android.content.Intent
import android.os.*
import android.util.Log
import id.dwichan.preloaddata.R
import id.dwichan.preloaddata.database.MahasiswaHelper
import id.dwichan.preloaddata.database.MahasiswaModel
import id.dwichan.preloaddata.pref.AppPreference
...
class DataManagerService : Service(), CoroutineScope {
    ...
    private fun getData(): Boolean {
        ...
        if (firstRun) {
            ...
            // insert query dengan standard query
            try {
